  ...
  return (
    <div className="px-4 py-6 sm:px-6 lg:px-8 space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {programs.length === 0 ? (
          <div className="col-span-full p-12 text-center border border-dashed border-gray-200 rounded-2xl bg-white shadow-xs">
            <Award size={32} className="mx-auto text-gray-300 mb-2" />
            <p className="text-sm font-bold text-gray-700">No current training programs scheduled</p>
            <p className="text-xs text-gray-400 mt-1">Scheduled training sessions and certifications will display here.</p>
          </div>
        ) : (
          programs.map((prog) => (
