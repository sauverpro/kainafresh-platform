...
const VALUE_PROPS = [
  {
    ...
    description: 'No synthetic chemicals. Every crop is grown using eco-friendly practices that are good for the soil and good for you.',
  },
  {
    icon: Truck,
    title: 'Fast Delivery',
    description: 'Order today, receive tomorrow. Our cold-chain logistics ensure your produce arrives as fresh as the day it was picked.',
  },
  {
    icon: ShieldCheck,
    title: 'Quality Guaranteed',
    description: "Every product is hand-inspected and graded before packing. If it's not perfect, it doesn't leave our farm.",
  },
  {
    icon: Package,
    title: 'Bulk & Wholesale',
    description: 'Need large volumes? We supply restaurants, supermarkets, and exporters with consistent, certified bulk produce.',
  },
];
...
const FAQS = [
  {
    ...
    answer: 'Browse our products, add your items to the cart, and checkout. You can pay on delivery or via mobile money. Orders placed before 2 PM are delivered the next day.',
  },
  {
    id: 2,
    question: 'Do you deliver to my area?',
    answer: 'We currently deliver across Kigali and surrounding districts. Enter your location at checkout to confirm delivery availability and estimated time.',
  },
  {
    id: 3,
    question: 'How do I know the produce is truly organic?',
    answer: 'KainaFresh is certified organic. Our farm undergoes regular inspections, and all products carry a certification label. You can visit our farm — we welcome it!',
  },
  {
    id: 4,
    question: 'Can I order in bulk for my business?',
    answer: 'Absolutely. We have a dedicated wholesale programme for restaurants, supermarkets, and exporters. Visit our Wholesale & Exports page or contact us directly.',
  },
  {
    id: 5,
    question: 'What if I receive produce that is not fresh?',
    answer: 'We stand behind every delivery. If anything isn\'t up to standard, contact us within 24 hours and we will replace it or issue a full refund — no questions asked.',
  },
];
      ...
      <main className="home-page">
            ...
            {VALUE_PROPS.map(({ icon: Icon, title, description }) => (
              <div key={title} className="vp-card card">
                <div className="vp-icon">
                  <Icon size={26} strokeWidth={1.8} color="var(--color-primary)" />
                </div>
                <h3>{title}</h3>
                <p>{description}</p>
              </div>
        ...
        <section className="home-cta">
          <div className="home-cta-inner">
            ...
            <p>Join over 350 households and businesses already ordering from KainaFresh.</p>
            <div className="home-cta-buttons">
              <Link to="/products" className="btn btn-primary">Start Shopping</Link>
              <Link to="/wholesale" className="btn btn-secondary">Wholesale Inquiries</Link>
            </div>
          </div>
        </section>
