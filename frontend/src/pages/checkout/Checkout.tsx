...
export default function Checkout() {
  ...
  const handleSubmitOrder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Derive first/last name robustly so a single-word name still produces a
      // valid last_name (the backend requires both).
      ...
      // Step 2: Create Order
      const orderPayload = {
        user_id: Number(user?.id) || 1, // From auth context, fallback to seed user
      ...
      const orderItemsPromises = cartItems.map(async (item) => {
        ...
        const itemResponse = await apiPost<{
          ...
          message?: string;
          data?: unknown;
        }>(`/api/orders/${orderId}/items`, itemPayload);

        if (!itemResponse.success) {
          throw new Error(
            `Failed to add product ${item.product.name} to order`,
          );
        }
        ...
        {orderConfirmation ? (
          <div className="py-16 px-6 md:px-[5%] max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-12 border border-[#076935]/15 shadow-2xl text-center">
              ...
              <h2
                className="text-3xl font-bold text-[#076935] mb-2"
              ...
              <p className="text-gray-600 text-lg mb-8">
                ...
                <strong>{orderConfirmation.form.fullName}</strong>. We are
                preparing your farm-fresh produce.
              </p>
              ...
              <div className="bg-[#f4faf7] border border-dashed border-[#076935] rounded-2xl p-5 flex flex-col items-center mb-8">
                ...
                <strong
                  className="text-3xl font-bold text-[#076935] tracking-wider my-1"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  {orderConfirmation.orderRef}
                </strong>
                <span className="text-xs text-gray-500">
                  Placed on {orderConfirmation.date}
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left mb-8">
                ...
                <div className="bg-[#FFFDF9] p-6 rounded-2xl border border-gray-100">
                  <h3
                    className="font-bold text-base text-[#076935] flex items-center gap-2 mb-3"
                    style={{ fontFamily: "var(--font-heading)" }}
                  >
                    <MapPin size={16} className="text-[#076935]" /> Delivery
                    Address
                  </h3>
                  <p className="text-sm text-gray-800 font-semibold mb-1">
                    {orderConfirmation.form.fullName}
                  </p>
                  <p className="text-sm text-gray-600 mb-1">
                    {orderConfirmation.form.address}
                  </p>
                  <p className="text-sm text-gray-600 mb-1">
                    {orderConfirmation.form.district}
                  </p>
                  <p className="text-sm text-gray-600 mb-1">
                    Phone: {orderConfirmation.form.phone}
                  </p>
                  {orderConfirmation.form.email && (
                    <p className="text-sm text-gray-600">
                      Email: {orderConfirmation.form.email}
                    </p>
                  )}
                </div>
                ...
                <div className="bg-[#FFFDF9] p-6 rounded-2xl border border-gray-100">
                  <h3
                    ...
                    style={{ fontFamily: "var(--font-heading)" }}
                  >
                    <CreditCard size={16} className="text-[#076935]" /> Payment
                    Details
                  </h3>
                  ...
                  <p className="text-sm text-gray-700 mb-3">
                    Status:{" "}
                    <span
                      className="inline-block bg-[#F39927]/15 text-[#F39927] text-xs font-bold px-2.5 py-0.5 rounded-full"
                      style={{ fontFamily: "var(--font-heading)" }}
                    >
                      Pending Delivery
                    </span>
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-100 flex items-center gap-2 text-sm text-gray-700">
                    ...
                    <span>
                      Estimated Delivery:{" "}
                      <strong>Tomorrow, 8:00 AM - 12:00 PM</strong>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-left bg-[#FFFDF9] p-6 rounded-2xl border border-gray-100 mb-8">
                <h3
                  className="font-bold text-base text-[#076935] mb-4"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
          ...
          <>
            ...
            <section className="py-14 px-6 md:px-[5%] bg-gradient-to-br from-[#076935]/[0.06] to-[#F39927]/[0.06]">
              <div className="max-w-7xl mx-auto">
                ...
                <h1
                  className="text-3xl md:text-4xl font-bold text-[#076935] mb-2"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  Checkout & Delivery Details
                </h1>
                <p className="text-gray-600 text-base">
                  Complete your shipping information and preferred payment
                  method to receive your fresh harvest.
                </p>
              </div>
            </section>
                ...
                <div className="lg:col-span-7 flex flex-col gap-6">
                  ...
                  >
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-[#076935]/10 shadow-xs">
                      <h2
                        className="text-xl font-bold text-[#076935] flex items-center gap-2 mb-6 pb-3 border-b border-gray-100"
                        style={{ fontFamily: "var(--font-heading)" }}
                      >
                        <User size={18} className="text-[#076935]" /> 1.
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="flex flex-col gap-1.5">
                          ...
                          >
                            <option value="Kigali - Gasabo">
                              Kigali - Gasabo
                            </option>
                            <option value="Kigali - Kicukiro">
                              Kigali - Kicukiro
                            </option>
                            <option value="Kigali - Nyarugenge">
                              Kigali - Nyarugenge
                            </option>
                            <option value="Bugesera / Outer Kigali">
                              Bugesera / Outer Kigali
                            </option>
                            <option value="Other District (Upcountry)">
                              Other District (Upcountry)
                            </option>
                          </select>
                        </div>
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-[#076935]/10 shadow-xs">
                      <h2
                        ...
                        style={{ fontFamily: "var(--font-heading)" }}
                      >
                        <CreditCard size={18} className="text-[#076935]" /> 2.
                        Payment Method
                      </h2>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        >
                          ...
                          <div>
                            <div
                              className="flex items-center gap-1.5 mb-1 text-sm font-bold text-gray-800"
                              style={{ fontFamily: "var(--font-heading)" }}
                            >
                            ...
                            <p className="text-xs text-gray-500 leading-snug m-0">
                              Pay instantly using MTN MoMo prompt
                              (*182*8*1*...#)
                            </p>
                          </div>
                        </label>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500 leading-snug m-0">
                              Pay via Airtel Money wallet code on delivery
                            </p>
                          </div>
                        </label>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500 leading-snug m-0">
                              Pay in cash directly to our rider upon inspect &
                              receipt
                            </p>
                          </div>
                        </label>
                    ...
                    >
                      {submitting ? (
                        ...
                        <>
                          <CheckCircle size={18} /> Place Order Now — RWF{" "}
                ...
                <div className="lg:col-span-5 sticky top-28">
                  <div className="bg-white p-8 rounded-3xl border border-[#076935]/10 shadow-xs">
                    <h2
                      ...
                      style={{ fontFamily: "var(--font-heading)" }}
                    >
                      <ShoppingBag size={18} className="text-[#076935]" /> Order
                      Summary
                    </h2>
                    ...
                    {cartItems.length === 0 ? (
                      <div className="text-center py-8 text-gray-500">
                        ...
                        <Link
                          to="/products"
                          className="inline-flex items-center gap-1.5 bg-transparent border-2 border-[#076935] text-[#076935] px-4 py-2 rounded-full text-xs font-semibold hover:bg-[#076935] hover:text-white transition-all"
                        >
                            ...
                            return (
                              ...
                              >
                                <img
                                  src={itemImg}
                                  alt={product.name}
                                  className="w-12 h-12 rounded-xl object-cover bg-[#f4faf7] shrink-0"
                                />
